    ...
    return (
      <div className="min-h-screen bg-neutral-950 flex items-center justify-center text-neutral-400">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-sm font-medium tracking-wide">Syncing your knowledge base...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-12">
        ...
        <header className="mb-12 flex items-center justify-between border-b border-white/10 pb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white tracking-tight">Study Companion</h1>
              <p className="text-neutral-500 text-sm">AI-powered knowledge management</p>
            </div>
          </div>
        </header>
        ...
        {notes.length === 0 ? (
          ...
          >
            ...
            <h3 className="text-xl font-medium text-neutral-300">No notes found</h3>
            <p className="text-neutral-500 mt-2">Start taking notes to see them here.</p>
          </motion.div>
        ) : (
          <motion.div
                ...
                <div className="p-4 pt-2 mt-auto border-t border-white/5 bg-neutral-900/40">
                  <button
                    ...
                    className={`
                      ...
                      ${summarizingId === note.id ? 'opacity-80 cursor-wait' : ''}
                    `}
                  >
